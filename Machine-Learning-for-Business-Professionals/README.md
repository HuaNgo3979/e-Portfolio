...
|:---:|:---:|:---:|---|---|---|
| Cell Phone Price | Kaggle | [CellPhone Data Source and Description](https://www.kaggle.com/datasets/atefehmirnaseri/cell-phone-price) | · 2,000 train / 1,000 test <br> · 20 predictors + `price_range` (4 balanced classes) <br> | [CellPhone_train_dataset.csv]() <br> [CellPhone_test_dataset.csv]() <br>| ‹TODO: `./Assessment-1-Azure-AI-Exercise/data/…`› |
